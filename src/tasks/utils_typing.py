...
class Entity:
    ...
    def __eq__(self: Entity, other: Entity) -> bool:
        ...
        if self._allow_partial_match:
            ...
            return type(self) == type(other) and (self_span in other_span or other_span in self_span)
...
class Relation:
    ...
    def __post_init__(self: Relation) -> None:
        self._allow_partial_match: bool = False
        self._allow_reversed_match: bool = False
        self._allow_partial_reversed_match: bool = False
    ...
    def __eq__(self: Value, other: Value) -> bool:
        ...
        if self._allow_partial_reversed_match:
            return (
                type(self) == type(other)
                and (
                    self.arg1 in other.arg1 or other.arg1 in self.arg1 
                    or
                    self.arg1 in other.arg2 or other.arg2 in self.arg1
                )
                and (
                    self.arg2 in other.arg2 or other.arg2 in self.arg2
                    or
                    self.arg2 in other.arg1 or other.arg1 in self.arg2
                )
            )
...
class AnnotationList(list):
    ...
    def from_output(
        ...
        while reading:
            ...
            except Exception:   # 出现了除了NameError之外的异常, 那么就记parse_error
                _elems = []
                reading = False
                parse_error = True

        if not isinstance(_elems, Iterable):
            _elems = [_elems]
